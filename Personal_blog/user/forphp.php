...
<body>
    ...
    <header>
        ...
        <div class="line">
            <div class="line-1"><a href="forphp.php">Home</a></div>
    ...
    <!-- Carousel Start -->
        ...
        <div id="tmain">
            <div class="mfirst">
                ...
                <div class="md-1">
                    <div class="md11">
                    <img class="md1img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTuk7z6XLIlULpFkron49oBzMgjd0LJ_99oqQ&s" alt="">
                    </div>
                    <div class="md12">
                        <h2>History of PHP</h2>
                        <p>PHP was created in 1994 by Rasmus Lerdorf as a set of CGI scripts to track visitors on his website. Originally called Personal Home Page Tools, it evolved into PHP: 
                            Hypertext Preprocessor, a server-side scripting language. PHP became popular for building dynamic websites and web applications due to its simplicity, speed, and integration with databases like MySQL. Over time, 
                            it gained frameworks like Laravel and Symfony, making development easier. Today, PHP powers many websites, including WordPress, making it a core web technology.</p>
                    </div>
                </div>
                <!-- why use -->
                <div class="md-2">
                    <div class="md21">
                    <img class="md2img" src="https://img.freepik.com/free-psd/php-code-icon_84443-57058.jpg?semt=ais_user_personalization&w=740&q=80" alt="">
                    </div>
                    <div class="md22">
                        <h2>Why using PHP ?</h2>
                        <p>PHP is used to create dynamic and interactive websites. It runs on the server, generating web pages quickly and efficiently. PHP easily connects with databases 
                            like MySQL, making it ideal for storing and retrieving data. It’s simple to learn, open-source, and widely supported by hosting providers. With frameworks like Laravel and Symfony, developers can build secure,
                             scalable applications faster. PHP powers many popular websites and content management systems, making it a reliable choice for web development projects.</p>
                    </div>
                </div>
                <!-- website link -->
                <div class="md-3">
                    <div class="md31">
                    <img class="md3img" src="https://learntocodewith.me/wp-content/uploads/2021/11/php-elephant-1024x683.jpg" alt="">
                    </div>
                    <div class="md32">
                        <h2>Learn PHP From Here</h2>
                        <p>PHP (Hypertext Preprocessor) is a widely-used, open-source, server-side scripting language designed primarily for web development to create dynamic and interactive websites. It is executed on the server, embedded within HTML, and can manage databases, 
                            sessions, and forms.</p>
                        <p>Link 1 :<a style="text-decoration: none;color: blue;" href="https://www.w3schools.com/php/" target="_blank"> W3 School</a></p>
                        <p>Link 2 :<a style="text-decoration: none;color: blue;" href="https://www.geeksforgeeks.org/php/php-tutorial/" target="_blank"> Geeksforgeeks</a></p><br>
                    </div>
                </div>
            </div>
            <div class="msecond">
                ...
                <div class="article">
                    <h3>Latest Article About PHP</h3>
